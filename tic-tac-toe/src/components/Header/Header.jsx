...
function Header() {
  ...
  return (
    <HeaderWrapper>
        {/* LOGO */}
        <svg className='logo' onClick={() => navigate("/")} xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" version="1.1" viewBox="0 0 300.95 300.95" xml:space="preserve">
            <g>
                <g>
                    <g>
